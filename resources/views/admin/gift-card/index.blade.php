                    ...
                    <div class="table-responsive-sm">
                        <table class="table table-bordered table-hover table-compact w-100" id="table">
                            ...
                            <tr>
                                ...
                                <th>{{ __('general.gift_card_name') }}</th>
                                <th>{{ __('general.gift_card_type') }}</th>
                                <th>{{ __('general.point_cost') }}</th>
                                <th>{{ __('general.description') }}</th>
                                <th>{{ __('general.terms') }}</th>
            ...
            $(function() {
                datatable = $('#table').DataTable({
                    ...
                    "buttons": [
                        ...
                        @can('hasAccess', (\App\Enums\AbilityEnum::CREATE . '_' . \App\Enums\KeywordEnum::GIFT_CARD))
                        {
                            ...
                            attr: {
                                'data-href': '{{ route('admin.gift-cards.create') }}',
                    ...
                    'ajax': {
                        'url': "{{ route('admin.gift-cards.index') }}",
                        'data': function (data) {
                        }
                    },
                    columns: [
