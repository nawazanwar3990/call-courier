                ...
                <div class="card-body">
                    <div class="table-responsive-sm">
                        <table class="table table-bordered table-hover table-compact w-100" id="table">
                            <thead>
                            <tr>
                                <th>{{ __('general.submitted_proof_image') }}</th>
                                <th>{{ __('general.username') }}</th>
                                <th>{{ __('general.task_name') }}</th>
                                <th>{{ __('general.task_coins') }}</th>
                                <th>{{ __('general.submitted_date') }}</th>
        ...
        <script>
            ...
            $(function() {
                datatable = $('#table').DataTable({
                    ...
                    columns: [
                        {data: 'submitted_proof_image', className: 'text-center'},
                        {data: 'username'},
                        {data: 'task_name'},
                        {data: 'task_coins'},
                        {data: 'submitted_date'},
