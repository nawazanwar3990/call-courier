                ...
                <div class="row">
                    <div class="col-12 text-end">
                        <div class="btn-group">
                            ...
                            @if($print)
                            <button type="button" id="printBtn" class="btn btn-outline-success waves-effect">
                                <i class="fa-regular fa-print fa-lg"></i><span
                                    class="d-none d-md-block">&nbsp;{{ __('general.print') }}</span>
                            </button>
                            @endif
                            <a  href="{{ $route }}"
