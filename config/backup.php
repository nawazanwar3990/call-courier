...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('GOOGLE_CLOUD_FOLDER_NAME', 'eventory'),
        ...
        'source' => [
            ...
            'files' => [
                 ...
                 * Example: base_path()
                 */
                'relative_path' => public_path('uploads'),
            ],
    ...
    'notifications' => [
        ...
        'notifications' => [
            \App\Notifications\BackupHasFailedNotification::class => [\App\Notifications\MattermostChannel::class],
//            \Spatie\Backup\Notifications\Notifications\UnhealthyBackupWasFoundNotification::class => ['mail'],
//            \Spatie\Backup\Notifications\Notifications\CleanupHasFailedNotification::class => ['mail'],
            \App\Notifications\BackupWasSuccessfulNotification::class => [\App\Notifications\MattermostChannel::class],
...
//            \Spatie\Backup\Notifications\Notifications\CleanupWasSuccessfulNotification::class => ['mail'],
    ...
    'monitor_backups' => [
        [
            'name' => env('GOOGLE_CLOUD_FOLDER_NAME', 'deskbook-erp'),
            'disks' => ['gcs'],
            'health_checks' => [
