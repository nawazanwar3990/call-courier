    ...
    dt_permission = dataTablePermissions.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              '<span class="text-nowrap"><button class="btn btn-md btn-icon me-2" data-bs-target="#editPermissionModal" data-bs-toggle="modal" data-bs-dismiss="modal"><i class="ti ti-edit"></i></button>' +
              '<button class="btn btn-md btn-icon delete-record"><i class="ti ti-trash"></i></button></span>'
            );
          }
        }
      ],
