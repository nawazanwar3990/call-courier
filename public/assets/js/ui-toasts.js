...
$(function () {
  ...
  var getMessage = function () {
    var msgs = [
      ...
      '<div class="mb-3"><input class="input-small form-control" value="Textbox"/>&nbsp;<a href="http://johnpapa.net" target="_blank">This is a hyperlink</a></div><div class="d-flex"><button type="button" id="okBtn" class="btn btn-primary btn-md me-2">Close me</button><button type="button" id="surpriseBtn" class="btn btn-md btn-secondary">Surprise me</button></div>',
